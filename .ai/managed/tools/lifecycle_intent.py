...
`import ai_ops_kit...` падает при запуске файла напрямую (`python3 tools/lifecycle_intent.py`)
...
if __name__ == "__main__":
    ...
    runpy.run_module("ai_ops_kit.lifecycle.lifecycle_intent", run_name="__main__", alter_sys=True)
else:
