"""Совместимость: плоское имя evidence_collector -> ai_ops_kit.gates.evidence_collector.
...
`import ai_ops_kit...` падает при запуске файла напрямую (`python3 tools/evidence_collector.py`)
...
if __name__ == "__main__":
    ...
    runpy.run_module("ai_ops_kit.gates.evidence_collector", run_name="__main__", alter_sys=True)
else:
    import ai_ops_kit.gates.evidence_collector as _target
