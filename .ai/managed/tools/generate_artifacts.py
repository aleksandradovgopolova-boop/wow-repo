...
`import ai_ops_kit...` падает при запуске файла напрямую (`python3 tools/generate_artifacts.py`)
...
if __name__ == "__main__":
    ...
    runpy.run_module("ai_ops_kit.shared.generate_artifacts", run_name="__main__", alter_sys=True)
else:
