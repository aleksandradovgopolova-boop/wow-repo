...
`import ai_ops_kit...` падает при запуске файла напрямую (`python3 tools/storybook_adapter.py`)
...
if __name__ == "__main__":
    ...
    runpy.run_module("ai_ops_kit.ui.storybook_adapter", run_name="__main__", alter_sys=True)
else:
