"""Совместимость: плоское имя verification_tiers -> ai_ops_kit.gates.verification_tiers.
...
`import ai_ops_kit...` падает при запуске файла напрямую (`python3 tools/verification_tiers.py`)
...
if __name__ == "__main__":
    ...
    runpy.run_module("ai_ops_kit.gates.verification_tiers", run_name="__main__", alter_sys=True)
else:
    import ai_ops_kit.gates.verification_tiers as _target
