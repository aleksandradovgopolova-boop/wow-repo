"""Совместимость: плоское имя data_classification -> ai_ops_kit.security.data_classification.
...
`import ai_ops_kit...` падает при запуске файла напрямую (`python3 tools/data_classification.py`)
...
if __name__ == "__main__":
    ...
    runpy.run_module("ai_ops_kit.security.data_classification", run_name="__main__", alter_sys=True)
else:
    import ai_ops_kit.security.data_classification as _target
