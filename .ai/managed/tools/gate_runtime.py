...
`import ai_ops_kit...` падает при запуске файла напрямую (`python3 tools/gate_runtime.py`)
...
if __name__ == "__main__":
    ...
    runpy.run_module("ai_ops_kit.gates.gate_runtime", run_name="__main__", alter_sys=True)
else:
