"""Совместимость: плоское имя short_path -> ai_ops_kit.planning.short_path.
...
if __name__ == "__main__":
    ...
    runpy.run_module("ai_ops_kit.planning.short_path", run_name="__main__", alter_sys=True)
else:
    import ai_ops_kit.planning.short_path as _target
