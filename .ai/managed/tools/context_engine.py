...
`import ai_ops_kit...` падает при запуске файла напрямую (`python3 tools/context_engine.py`)
...
if __name__ == "__main__":
    ...
    runpy.run_module("ai_ops_kit.context.context_engine", run_name="__main__", alter_sys=True)
else:
