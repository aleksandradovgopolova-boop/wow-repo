...
`import ai_ops_kit...` падает при запуске файла напрямую (`python3 tools/project_detector.py`)
...
if __name__ == "__main__":
    ...
    runpy.run_module("ai_ops_kit.shared.project_detector", run_name="__main__", alter_sys=True)
else:
