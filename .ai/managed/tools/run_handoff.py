"""Совместимость: плоское имя run_handoff -> ai_ops_kit.engine.run_handoff.
...
`import ai_ops_kit...` падает при запуске файла напрямую (`python3 tools/run_handoff.py`)
...
if __name__ == "__main__":
    ...
    runpy.run_module("ai_ops_kit.engine.run_handoff", run_name="__main__", alter_sys=True)
else:
    import ai_ops_kit.engine.run_handoff as _target
