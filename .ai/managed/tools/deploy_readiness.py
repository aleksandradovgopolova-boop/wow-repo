"""Совместимость: плоское имя deploy_readiness -> ai_ops_kit.gates.deploy_readiness.
...
`import ai_ops_kit...` падает при запуске файла напрямую (`python3 tools/deploy_readiness.py`)
...
if __name__ == "__main__":
    ...
    runpy.run_module("ai_ops_kit.gates.deploy_readiness", run_name="__main__", alter_sys=True)
else:
    import ai_ops_kit.gates.deploy_readiness as _target
