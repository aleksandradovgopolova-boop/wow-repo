"""Совместимость: плоское имя process_spend -> ai_ops_kit.engops.process_spend.
...
if __name__ == "__main__":
    ...
    runpy.run_module("ai_ops_kit.engops.process_spend", run_name="__main__", alter_sys=True)
else:
    import ai_ops_kit.engops.process_spend as _target
