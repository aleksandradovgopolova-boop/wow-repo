...
`import ai_ops_kit...` падает при запуске файла напрямую (`python3 tools/orchestrator_http.py`)
...
if __name__ == "__main__":
    ...
    runpy.run_module("ai_ops_kit.providers.orchestrator_http", run_name="__main__", alter_sys=True)
else:
