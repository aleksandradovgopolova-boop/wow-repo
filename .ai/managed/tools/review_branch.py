...
`import ai_ops_kit...` падает при запуске файла напрямую (`python3 tools/review_branch.py`)
...
if __name__ == "__main__":
    ...
    runpy.run_module("ai_ops_kit.delivery.review_branch", run_name="__main__", alter_sys=True)
else:
