"""Совместимость: плоское имя cost_method -> ai_ops_kit.providers.cost_method.
...
`import ai_ops_kit...` падает при запуске файла напрямую (`python3 tools/cost_method.py`)
...
if __name__ == "__main__":
    ...
    runpy.run_module("ai_ops_kit.providers.cost_method", run_name="__main__", alter_sys=True)
else:
    import ai_ops_kit.providers.cost_method as _target
