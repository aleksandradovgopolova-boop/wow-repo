"""Совместимость: плоское имя usage_ledger -> ai_ops_kit.shared.usage_ledger.
...
`import ai_ops_kit...` падает при запуске файла напрямую (`python3 tools/usage_ledger.py`)
...
if __name__ == "__main__":
    ...
    runpy.run_module("ai_ops_kit.shared.usage_ledger", run_name="__main__", alter_sys=True)
else:
    import ai_ops_kit.shared.usage_ledger as _target
