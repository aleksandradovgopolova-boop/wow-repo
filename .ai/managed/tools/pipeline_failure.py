"""Совместимость: плоское имя pipeline_failure -> ai_ops_kit.engine.pipeline_failure.
...
`import ai_ops_kit...` падает при запуске файла напрямую (`python3 tools/pipeline_failure.py`)
...
if __name__ == "__main__":
    ...
    runpy.run_module("ai_ops_kit.engine.pipeline_failure", run_name="__main__", alter_sys=True)
else:
    import ai_ops_kit.engine.pipeline_failure as _target
