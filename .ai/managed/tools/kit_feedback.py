"""Совместимость: плоское имя kit_feedback -> ai_ops_kit.engops.kit_feedback.
...
if __name__ == "__main__":
    ...
    runpy.run_module("ai_ops_kit.engops.kit_feedback", run_name="__main__", alter_sys=True)
else:
    import ai_ops_kit.engops.kit_feedback as _target
