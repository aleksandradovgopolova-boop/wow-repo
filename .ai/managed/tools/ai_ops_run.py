...
`import ai_ops_kit...` падает при запуске файла напрямую (`python3 tools/ai_ops_run.py`)
...
if __name__ == "__main__":
    ...
    runpy.run_module("ai_ops_kit.engine.ai_ops_run", run_name="__main__", alter_sys=True)
else:
