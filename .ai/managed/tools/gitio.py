"""Совместимость: плоское имя gitio -> ai_ops_kit.shared.gitio.
...
if __name__ == "__main__":
    ...
    runpy.run_module("ai_ops_kit.shared.gitio", run_name="__main__", alter_sys=True)
else:
    import ai_ops_kit.shared.gitio as _target
