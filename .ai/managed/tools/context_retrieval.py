...
`import ai_ops_kit...` падает при запуске файла напрямую (`python3 tools/context_retrieval.py`)
...
if __name__ == "__main__":
    ...
    runpy.run_module("ai_ops_kit.context.context_retrieval", run_name="__main__", alter_sys=True)
else:
