"""Совместимость: плоское имя session_telemetry -> ai_ops_kit.engops.session_telemetry.
...
`import ai_ops_kit...` падает при запуске файла напрямую (`python3 tools/session_telemetry.py`)
...
if __name__ == "__main__":
    ...
    runpy.run_module("ai_ops_kit.engops.session_telemetry", run_name="__main__", alter_sys=True)
else:
    import ai_ops_kit.engops.session_telemetry as _target
