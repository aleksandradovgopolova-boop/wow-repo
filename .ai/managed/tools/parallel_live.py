...
`import ai_ops_kit...` падает при запуске файла напрямую (`python3 tools/parallel_live.py`)
...
if __name__ == "__main__":
    ...
    runpy.run_module("ai_ops_kit.engine.parallel_live", run_name="__main__", alter_sys=True)
else:
