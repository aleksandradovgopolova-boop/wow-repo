"""Совместимость: плоское имя session_handoff -> ai_ops_kit.engops.session_handoff.
...
if __name__ == "__main__":
    ...
    runpy.run_module("ai_ops_kit.engops.session_handoff", run_name="__main__", alter_sys=True)
else:
    import ai_ops_kit.engops.session_handoff as _target
