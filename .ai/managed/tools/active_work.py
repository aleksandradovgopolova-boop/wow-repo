...
`import ai_ops_kit...` падает при запуске файла напрямую (`python3 tools/active_work.py`)
...
if __name__ == "__main__":
    ...
    runpy.run_module("ai_ops_kit.lifecycle.active_work", run_name="__main__", alter_sys=True)
else:
