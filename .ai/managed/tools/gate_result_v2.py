...
`import ai_ops_kit...` падает при запуске файла напрямую (`python3 tools/gate_result_v2.py`)
...
if __name__ == "__main__":
    ...
    runpy.run_module("ai_ops_kit.gates.gate_result_v2", run_name="__main__", alter_sys=True)
else:
