...
`import ai_ops_kit...` падает при запуске файла напрямую (`python3 tools/engineering_advisor.py`)
...
if __name__ == "__main__":
    ...
    runpy.run_module("ai_ops_kit.engops.engineering_advisor", run_name="__main__", alter_sys=True)
else:
