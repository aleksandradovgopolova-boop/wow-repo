"""Совместимость: плоское имя workpackage_executor -> ai_ops_kit.engine.workpackage_executor.
...
`import ai_ops_kit...` падает при запуске файла напрямую (`python3 tools/workpackage_executor.py`)
...
if __name__ == "__main__":
    ...
    runpy.run_module("ai_ops_kit.engine.workpackage_executor", run_name="__main__", alter_sys=True)
else:
    import ai_ops_kit.engine.workpackage_executor as _target
