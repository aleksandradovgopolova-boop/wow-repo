...
`import ai_ops_kit...` падает при запуске файла напрямую (`python3 tools/merge_memory.py`)
...
if __name__ == "__main__":
    ...
    runpy.run_module("ai_ops_kit.lifecycle.merge_memory", run_name="__main__", alter_sys=True)
else:
