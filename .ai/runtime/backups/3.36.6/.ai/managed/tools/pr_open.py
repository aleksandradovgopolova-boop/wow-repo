...
`import ai_ops_kit...` падает при запуске файла напрямую (`python3 tools/pr_open.py`)
...
if __name__ == "__main__":
    ...
    runpy.run_module("ai_ops_kit.delivery.pr_open", run_name="__main__", alter_sys=True)
else:
