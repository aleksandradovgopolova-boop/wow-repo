"""Совместимость: плоское имя roadmap -> ai_ops_kit.planning.roadmap.
...
if __name__ == "__main__":
    ...
    runpy.run_module("ai_ops_kit.planning.roadmap", run_name="__main__", alter_sys=True)
else:
    import ai_ops_kit.planning.roadmap as _target
