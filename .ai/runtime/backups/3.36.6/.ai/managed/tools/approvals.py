"""Совместимость: плоское имя approvals -> ai_ops_kit.gates.approvals.
...
`import ai_ops_kit...` падает при запуске файла напрямую (`python3 tools/approvals.py`)
...
if __name__ == "__main__":
    ...
    runpy.run_module("ai_ops_kit.gates.approvals", run_name="__main__", alter_sys=True)
else:
    import ai_ops_kit.gates.approvals as _target
