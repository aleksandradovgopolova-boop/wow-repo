...
`import ai_ops_kit...` падает при запуске файла напрямую (`python3 tools/provider_endpoints.py`)
...
if __name__ == "__main__":
    ...
    runpy.run_module("ai_ops_kit.providers.provider_endpoints", run_name="__main__", alter_sys=True)
else:
