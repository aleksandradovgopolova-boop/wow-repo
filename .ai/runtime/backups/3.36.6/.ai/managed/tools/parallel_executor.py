"""Совместимость: плоское имя parallel_executor -> ai_ops_kit.engine.parallel_executor.
...
`import ai_ops_kit...` падает при запуске файла напрямую (`python3 tools/parallel_executor.py`)
...
if __name__ == "__main__":
    ...
    runpy.run_module("ai_ops_kit.engine.parallel_executor", run_name="__main__", alter_sys=True)
else:
    import ai_ops_kit.engine.parallel_executor as _target
