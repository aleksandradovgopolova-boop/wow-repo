"""Совместимость: плоское имя regression_evidence -> ai_ops_kit.gates.regression_evidence.
...
`import ai_ops_kit...` падает при запуске файла напрямую (`python3 tools/regression_evidence.py`)
...
if __name__ == "__main__":
    ...
    runpy.run_module("ai_ops_kit.gates.regression_evidence", run_name="__main__", alter_sys=True)
else:
    import ai_ops_kit.gates.regression_evidence as _target
