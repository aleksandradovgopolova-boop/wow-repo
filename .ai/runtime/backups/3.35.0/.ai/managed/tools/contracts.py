"""Совместимость: плоское имя contracts -> ai_ops_kit.shared.contracts.
...
`import ai_ops_kit...` падает при запуске файла напрямую (`python3 tools/contracts.py`)
...
if __name__ == "__main__":
    ...
    runpy.run_module("ai_ops_kit.shared.contracts", run_name="__main__", alter_sys=True)
else:
    import ai_ops_kit.shared.contracts as _target
