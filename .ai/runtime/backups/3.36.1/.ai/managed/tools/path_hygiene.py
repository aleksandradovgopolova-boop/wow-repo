"""Совместимость: плоское имя path_hygiene -> ai_ops_kit.shared.path_hygiene.
...
`import ai_ops_kit...` падает при запуске файла напрямую (`python3 tools/path_hygiene.py`)
...
if __name__ == "__main__":
    ...
    runpy.run_module("ai_ops_kit.shared.path_hygiene", run_name="__main__", alter_sys=True)
else:
    import ai_ops_kit.shared.path_hygiene as _target
