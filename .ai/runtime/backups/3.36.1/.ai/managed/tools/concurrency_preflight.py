...
`import ai_ops_kit...` падает при запуске файла напрямую (`python3 tools/concurrency_preflight.py`)
...
if __name__ == "__main__":
    ...
    runpy.run_module("ai_ops_kit.gates.concurrency_preflight", run_name="__main__", alter_sys=True)
else:
