"""Совместимость: плоское имя storybook_query -> ai_ops_kit.ui.storybook_query.
...
`import ai_ops_kit...` падает при запуске файла напрямую (`python3 tools/storybook_query.py`)
...
if __name__ == "__main__":
    ...
    runpy.run_module("ai_ops_kit.ui.storybook_query", run_name="__main__", alter_sys=True)
else:
    import ai_ops_kit.ui.storybook_query as _target
