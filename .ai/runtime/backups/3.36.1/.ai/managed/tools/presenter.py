"""Совместимость: плоское имя presenter -> ai_ops_kit.ui.presenter.
...
if __name__ == "__main__":
    ...
    runpy.run_module("ai_ops_kit.ui.presenter", run_name="__main__", alter_sys=True)
else:
    import ai_ops_kit.ui.presenter as _target
