"""Совместимость: плоское имя repo_audit -> ai_ops_kit.planning.repo_audit.
...
if __name__ == "__main__":
    ...
    runpy.run_module("ai_ops_kit.planning.repo_audit", run_name="__main__", alter_sys=True)
else:
    import ai_ops_kit.planning.repo_audit as _target
