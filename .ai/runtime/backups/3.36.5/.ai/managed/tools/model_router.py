...
`import ai_ops_kit...` падает при запуске файла напрямую (`python3 tools/model_router.py`)
...
if __name__ == "__main__":
    ...
    runpy.run_module("ai_ops_kit.providers.model_router", run_name="__main__", alter_sys=True)
else:
