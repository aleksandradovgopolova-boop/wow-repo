"""Совместимость: плоское имя context_compiler -> ai_ops_kit.context.context_compiler.
...
`import ai_ops_kit...` падает при запуске файла напрямую (`python3 tools/context_compiler.py`)
...
if __name__ == "__main__":
    ...
    runpy.run_module("ai_ops_kit.context.context_compiler", run_name="__main__", alter_sys=True)
else:
    import ai_ops_kit.context.context_compiler as _target
