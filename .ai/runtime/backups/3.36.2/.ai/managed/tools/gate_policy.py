"""Совместимость: плоское имя gate_policy -> ai_ops_kit.gates.gate_policy.
...
`import ai_ops_kit...` падает при запуске файла напрямую (`python3 tools/gate_policy.py`)
...
if __name__ == "__main__":
    ...
    runpy.run_module("ai_ops_kit.gates.gate_policy", run_name="__main__", alter_sys=True)
else:
    import ai_ops_kit.gates.gate_policy as _target
