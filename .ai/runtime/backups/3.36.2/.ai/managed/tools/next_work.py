"""Совместимость: плоское имя next_work -> ai_ops_kit.planning.next_work.
...
if __name__ == "__main__":
    ...
    runpy.run_module("ai_ops_kit.planning.next_work", run_name="__main__", alter_sys=True)
else:
    import ai_ops_kit.planning.next_work as _target
