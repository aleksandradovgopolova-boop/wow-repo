"""Совместимость: плоское имя ui_readiness -> ai_ops_kit.ui.ui_readiness.
...
`import ai_ops_kit...` падает при запуске файла напрямую (`python3 tools/ui_readiness.py`)
...
if __name__ == "__main__":
    ...
    runpy.run_module("ai_ops_kit.ui.ui_readiness", run_name="__main__", alter_sys=True)
else:
    import ai_ops_kit.ui.ui_readiness as _target
