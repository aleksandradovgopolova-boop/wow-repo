"""Совместимость: плоское имя evolution_triggers -> ai_ops_kit.intelligence.evolution_triggers.
...
`import ai_ops_kit...` падает при запуске файла напрямую (`python3 tools/evolution_triggers.py`)
...
if __name__ == "__main__":
    ...
    runpy.run_module("ai_ops_kit.intelligence.evolution_triggers", run_name="__main__", alter_sys=True)
else:
    import ai_ops_kit.intelligence.evolution_triggers as _target
