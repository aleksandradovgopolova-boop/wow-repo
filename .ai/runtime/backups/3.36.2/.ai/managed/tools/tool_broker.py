"""Совместимость: плоское имя tool_broker -> ai_ops_kit.engine.tool_broker.
...
`import ai_ops_kit...` падает при запуске файла напрямую (`python3 tools/tool_broker.py`)
...
if __name__ == "__main__":
    ...
    runpy.run_module("ai_ops_kit.engine.tool_broker", run_name="__main__", alter_sys=True)
else:
    import ai_ops_kit.engine.tool_broker as _target
