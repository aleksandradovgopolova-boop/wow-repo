...
`import ai_ops_kit...` падает при запуске файла напрямую (`python3 tools/security_review_cascade.py`)
...
if __name__ == "__main__":
    ...
    runpy.run_module("ai_ops_kit.security.security_review_cascade", run_name="__main__", alter_sys=True)
else:
