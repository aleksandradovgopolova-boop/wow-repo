"""Совместимость: плоское имя delivery_plan -> ai_ops_kit.planning.delivery_plan.
...
if __name__ == "__main__":
    ...
    runpy.run_module("ai_ops_kit.planning.delivery_plan", run_name="__main__", alter_sys=True)
else:
    import ai_ops_kit.planning.delivery_plan as _target
