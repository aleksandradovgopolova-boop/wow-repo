"""Совместимость: плоское имя product_health -> ai_ops_kit.intelligence.product_health.
...
if __name__ == "__main__":
    ...
    runpy.run_module("ai_ops_kit.intelligence.product_health", run_name="__main__", alter_sys=True)
else:
    import ai_ops_kit.intelligence.product_health as _target
